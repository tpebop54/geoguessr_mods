...
const watchRoundEnd = () => {
    const prepNewRound = () => {
        if (_IS_DUEL) {
            ...
            if (!!resultMap && !!nextRoundButton) { // Seeing map and button together for the first time on this page.
            ...
            } else if (!!_RESULT_MAP || !!_NEXT_ROUND_BUTTON) { // Result page elements disappeard; trigger new round setup.
                _RESULT_MAP = null;
